...
console.log("Step 3");
console.log("There are " + vnum + " vowels in the string");

//STEP 4

let uLength = Number(window.prompt("Enter the length of the random string ID", 6));
...
let choice;
let countryList1 = ["Australia", "Germany", "United States of America"];
let countryList2 = [
    "Afghanistan",
    "Albania",
    "Algeria",
...
let listChoice = window.prompt("Choose the short[1] or long[2] list. Enter in 1 or 2", 1)
...
let longestCountryName = choice.sort(function (a, b) { return b.length - a.length })[0];
